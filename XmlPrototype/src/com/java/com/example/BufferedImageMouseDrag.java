...
class DisplayCanvas extends JPanel {
  ...
  DisplayCanvas() {
    ...
    Image image = Toolkit.getDefaultToolkit().getImage(Utils.getAbstractAddr()+"/com/java/res/pic/menu_button.gif");
//    Image image = new Image(new File(Utils.getAbstractAddr()+"/com/java/res/pic/send_btn.png"));
